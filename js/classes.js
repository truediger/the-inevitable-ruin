...
const SKILL_DATA = {
    ...
    fireball: {
        name: 'Fireball',
        type: 'active',
        description: 'Attaches a flame to the target. If it dies, it explodes.',
        cooldown: 5,
        damage: 1.2,
        aoeRadius: 60,
        projSpeed: 600,
    ...
    flame_strike: {
        ...
        upgrades: {
            ...
            b: { name: 'Instant Ignition', description: 'No delay, radius 60, 4s CD', noDelay: true, radiusMult: 0.75, cooldownOverride: 4 },
        },
    },
    fire_wall: {
        name: 'Fire Wall',
